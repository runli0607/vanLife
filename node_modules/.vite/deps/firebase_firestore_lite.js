...
var CompositeFilter = class _CompositeFilter extends Filter {
  ...
  getFirstInequalityField() {
    const t = this.N((t2) => t2.isInequality());
...
function __PRIVATE_getFirstOrderByField(t) {
...
function __PRIVATE_queryNormalizedOrderBy(t) {
  ...
  if (null === e.q) {
    e.q = [];
    const t2 = __PRIVATE_getInequalityFilterField(e), r = __PRIVATE_getFirstOrderByField(e);
    if (null !== t2 && null === r)
      t2.isKeyField() || e.q.push(new OrderBy(t2)), e.q.push(new OrderBy(
...
function __PRIVATE_toResourceName(t, e) {
  return function __PRIVATE_fullyQualifiedPrefixPath(t2) {
...
function __PRIVATE_toQueryTarget(t, e) {
  ...
  const i = function __PRIVATE_toFilters(t2) {
    if (0 === t2.length)
      return;
  ...
  const s = function __PRIVATE_toOrder(t2) {
    if (0 === t2.length)
      return;
    return t2.map((t3) => (
      // visible for testing
  ...
  const o = function __PRIVATE_toInt32Proto(t2, e2) {
    return t2.useProto3Json || __PRIVATE_isNullOrUndefined(e2) ? e2 : {
      value: e2
    };
  }(t, e.limit);
  return null !== o && (r.structuredQuery.limit = o), e.startAt && (r.structuredQuery.startAt = function __PRIVATE_toStartAtCursor(t2) {
    return {
      before: t2.inclusive,
      values: t2.position
    };
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(t, e, r = 1e3, n = 1.5, i = 6e4) {
    this.M = t, this.timerId = e, this.k = r, this.U = n, this.j = i, this.W = 0, this.K = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  J(t) {
    ...
    n > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${n} ms (base delay: ${this.W} ms, delay with jitter: ${e} ms, last attempt: ${r} ms ago)`), this.K = this.M.enqueueAfterDelay(this.timerId, n, () => (this.G = Date.now(), t())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  constructor(t, e, r, n) {
    super(), this.authCredentials = t, this.appCheckCredentials = e, this.connection = r, this.serializer = n, this.X = false;
  }
  tt() {
    if (this.X)
  ...
  R(t, e, r) {
    return this.tt(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([n, i]) => this.connection.R(t, e, r, n, i)).catch((t2) => {
  ...
  g(t, e, r, n) {
    return this.tt(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.g(t, e, r, i, s, n)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === p && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new FirestoreError(A, t2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeBatchGetDocumentsRpc(t, e) {
  ...
  }, s = await r.g("BatchGetDocuments", n, i, e.length), o = /* @__PURE__ */ new Map();
  s.forEach((t2) => {
  ...
  return e.forEach((t2) => {
    ...
    __PRIVATE_hardAssert(!!e2), a.push(e2);
  }), a;
}
async function __PRIVATE_invokeRunQueryRpc(t, e) {
  ...
  return (await r.g("RunQuery", n.parent, {
    ...
    const n2 = fromName(t3, e2.name), i = __PRIVATE_fromVersion(e2.updateTime), s = e2.createTime ? __PRIVATE_fromVersion(e2.createTime) : SnapshotVersion.min(), o = new ObjectValue({
      mapValue: {
        fields: e2.fields
      }
    }), a = MutableDocument.newFoundDocument(n2, i, s, o);
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
  var n;
  const i = __PRIVATE_debugCast(t), { request: s, et: o } = function __PRIVATE_toRunAggregationQueryRequest(t2, e2, r2) {
    const n2 = __PRIVATE_toQueryTarget(t2, e2), i2 = {}, s2 = [];
    let o2 = 0;
    return r2.forEach((t3) => {
      const e3 = "aggregate_" + o2++;
      i2[e3] = t3.alias, "count" === t3.D ? s2.push({
        alias: e3,
        count: {}
      }) : "avg" === t3.D ? s2.push({
        alias: e3,
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  ct(t) {
    return __PRIVATE_createError(t, this.settings.methodName, this.settings.ht || false, this.path, this.settings.dt);
  }
  ...
  ut(t) {
    ...
    if (__PRIVATE_isWrite(this.nt) && U.test(t))
...
function __PRIVATE_parseSetData(t, e, r, n, i, s = {}) {
  const o = t.ft(s.merge || s.mergeFields ? 2 : 0, e, r, i);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(t) {
    if (2 !== t.nt)
      throw 1 === t.nt ? t.ct(`${this._methodName}() can only appear at the top level of your update data`) : t.ct(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(t) {
    const e = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.Et.map((t2) => __PRIVATE_parseData(t2, e)), n = new __PRIVATE_ArrayUnionTransformOperation(r);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(t) {
    const e = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.Et.map((t2) => __PRIVATE_parseData(t2, e)), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
    return new FieldTransform(t.path, n);
  }
  isEqual(t) {
    return this === t;
...
function __PRIVATE_parseUpdateVarargs(t, e, r, n, i, s) {
  const o = t.ft(1, e, r), a = [__PRIVATE_fieldPathFromArgument$1(e, n, r)], u = [i];
  if (s.length % 2 != 0)
...
function __PRIVATE_parseQueryValue(t, e, r, n = false) {
  return __PRIVATE_parseData(r, t.ft(n ? 4 : 3, e));
}
function __PRIVATE_parseData(t, e) {
  ...
  return function __PRIVATE_parseScalarValue(t2, e2) {
    ...
    if (t2 instanceof DocumentReference) {
      ...
      if (!n.isEqual(r))
        throw e2.ct(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);
      return {
...
function __PRIVATE_parseObject(t, e) {
  ...
  return !function isEmpty(t2) {
    ...
    const i = __PRIVATE_parseData(n, e.st(t2));
    null != i && (r[t2] = i);
  }) : (
...
var QueryOrderByConstraint = class _QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(t) {
    const e = function __PRIVATE_newQueryOrderBy(t2, e2, r) {
      ...
      return function __PRIVATE_validateNewOrderBy(t3, e3) {
        if (null === __PRIVATE_getFirstOrderByField(t3)) {
          const r2 = __PRIVATE_getInequalityFilterField(t3);
          null !== r2 && __PRIVATE_validateOrderByAndInequalityMatch(t3, r2, e3.field);
        }
      }(t2, n), n;
...
function __PRIVATE_newQueryBoundFromDocOrFields(t, e, r, n) {
  if (r[0] = getModularInstance(r[0]), r[0] instanceof DocumentSnapshot)
    return function __PRIVATE_newQueryBoundFromDocument(t2, e2, r2, n2, i) {
      if (!n2)
        throw new FirestoreError(R, `Can't use a DocumentSnapshot that doesn't exist for ${r2}().`);
      const s = [];
...
function __PRIVATE_validateNewFieldFilter(t, e) {
  if (e.isInequality()) {
    const r2 = __PRIVATE_getInequalityFilterField(t), n = e.field;
    if (null !== r2 && !r2.isEqual(n))
      throw new FirestoreError(T, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${r2.toString()}' and '${n.toString()}'`);
...
function __PRIVATE_validateOrderByAndInequalityMatch(t, e, r) {
  if (!r.isEqual(e))
    throw new FirestoreError(T, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${r.toString()}' instead.`);
}
...
function getAggregate(t, e) {
  const r = __PRIVATE_cast(t.firestore, Firestore), n = __PRIVATE_getDatastore(r), i = function __PRIVATE_mapToArray(t2, e2) {
    ...
    return r2;
  }(e, (t2, e2) => new __PRIVATE_AggregateImpl(e2, t2._aggregateType, t2._internalFieldPath));
...
var Transaction$1 = class {
  ...
  async lookup(t) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0)
      throw new FirestoreError(T, "Firestore transactions require all reads to be executed before all writes.");
...
var __PRIVATE_TransactionRunner = class {
  constructor(t, e, r, n, i) {
    this.asyncQueue = t, this.datastore = e, this.options = r, this.updateFunction = n, this.deferred = i, this.Tt = r.maxAttempts, this.Pt = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Vt(t) {
    this.Tt > 0 && this.yt(t) ? (this.Tt -= 1, this.asyncQueue.enqueueAndForget(() => (this.Rt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  yt(t) {
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    this.wt = Promise.resolve(), // A list of retryable operations. Retryable operations are run in order and
    // retried with backoff.
    this.gt = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
    this.Ft = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.vt = [], // visible for testing
    this.Dt = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.bt = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Ct = false, // List of TimerIds to fast-forward delays for.
    this.St = [], // Backoff timer used to schedule retries for retryable operations
    this.Pt = new __PRIVATE_ExponentialBackoff(
      this,
      "async_queue_retry"
    ...
    this.Nt = () => {
      ...
      t2 && __PRIVATE_logDebug("AsyncQueue", "Visibility state changed to " + t2.visibilityState), this.Pt.Z();
    };
    const t = getDocument();
  ...
  enqueue(t) {
    ...
    return this.qt(() => this.Ft && this.Ct ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  enqueueRetryable(t) {
  ...
  async Bt() {
    if (0 !== this.gt.length) {
      ...
      this.gt.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  qt(t) {
    const e = this.wt.then(() => (this.bt = true, t().catch((t2) => {
      this.Dt = t2, this.bt = false;
      const e2 = (
        /**
    ...
    }).then((t2) => (this.bt = false, t2))));
    return this.wt = e, e;
  }
  enqueueAfterDelay(t, e, r) {
    this.Ot(), // Fast-forward delays for timerIds that have been overriden.
...
function runTransaction(t, e, r) {
  ...
  }(), n, i, (r2) => e(new Transaction(t, r2)), s).run(), s.promise;
}
!function __PRIVATE_registerFirestore() {
  ...
  registerVersion("firestore-lite", "4.1.1", ""), registerVersion("firestore-lite", "4.1.1", "esm2017");
}();
export {
  AggregateField,
